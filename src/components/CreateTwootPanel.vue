<template>
  <form class="create-twoot-panel" @submit.prevent="createNewTwoot" :class="{ '--exceeded': state.newTwootCharCount > 180 }">
    <label for="newTwoot"><strong>New Twoot</strong> ({{ state.newTwootCharCount }})/180</label>
